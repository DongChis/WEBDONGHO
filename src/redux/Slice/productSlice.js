  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchNewProducts.fulfilled, (state, action) => {
        ...
        const cart = checkCart();
        state.newProducts = updateProductCartStatus(newProducts, cart);
        state.status = "succeeded";
      })
...
export const { loadProducts, loadProductHot, searchProducts } =
...
export const loadNewProductsSelector = (state) => state.products.newProducts;

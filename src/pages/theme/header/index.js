    ...
    import { loginStart, loginSuccess, loginFailure, logout } from '../../../redux/Slice/authSlice';
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-6 header__top_left">
                                <ul>
                                    <li><AiOutlineMail />watchstore@gmail.com</li>
                                    <li><AiTwotoneCar />Free ship trên toàn quốc</li>
                                </ul>
                            </div>
                            <div className="col-6 header__top_right">
                                <ul>
                                    ...
                                    <li><Link to="#"><AiTwotoneStar /></Link></li>
                                    <li>
                                        <button onClick={() => {
                                            if (isAuthenticated) {
